...
module Productions =
    ...
    let containsLineTerminator (v:string) =
        v.IndexOfAny lineTerminatorChars >= 0

    let trimCharacters = Array.concat [ whiteSpaceChars; lineTerminatorChars ]
    ...
    let whiteSpaceCharsRegExp = 
        String (Array.concat [ whiteSpaceChars; lineTerminatorChars ])
