...
namespace Machete.Runtime.RuntimeTypes
{
    ...
    {
        public abstract LType Value { get; set; }
        ...
        public abstract LType ConvertToPrimitive(string preferredType = null);
        ...
        public abstract LNumber ConvertToInteger();
        public abstract LNumber ConvertToInt32();
        public abstract LNumber ConvertToUInt32();
        public abstract LNumber ConvertToUInt16();
    }
}