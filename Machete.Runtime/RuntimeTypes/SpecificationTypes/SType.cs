...
{
    public abstract class SType : RType
    {
        ...
        public override LType ConvertToPrimitive(string preferredType = null)
        {
            throw new InvalidOperationException();
        }
        ...
        public override LNumber ConvertToInteger()
        {
            throw new InvalidOperationException();
        }

        public override LNumber ConvertToInt32()
        {
            throw new InvalidOperationException();
        }

        public override LNumber ConvertToUInt32()
        {
            throw new InvalidOperationException();
        }

        public override LNumber ConvertToUInt16()
        {
            throw new InvalidOperationException();
        }
    }
